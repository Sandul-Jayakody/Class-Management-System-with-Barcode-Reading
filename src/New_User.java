...
public class New_User extends javax.swing.JFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(usertype, 0, 189, Short.MAX_VALUE))))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        {JOptionPane.showMessageDialog(this,"Password not match");}
             ...
             try {
            theQuery("insert into user (`username`, `password`, `utype`)  values ('" + username.getText() + "','" + password.getText() + " ',' " + usertype.getSelectedItem().toString()+ "')");
        } catch (Exception ex) {
        }
    } 
    }
